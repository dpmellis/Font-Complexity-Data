...
exportData = [['Font Name', 'Family', 'Serif', 'Weight', 'Optical Size', 'Italic', 'Font Width', 'Style', 'Case', 'Glyph Name', 'Glyph Width', 'Glyph Height', 'Shape Width', 'Shape Height',  'Shape Area', 'On Curve Points', 'Total Points']] #Headings for the data, 
...
print(i)
exportData=[]
for currentFont in fontNames[i*10:(i+1)*10]: 
    #Extract uppercase data
    exportData = exportData + extractData(upperCase,currentFont + ['Upper'])
    #Extract lowercase data
    exportData = exportData + extractData(lowerCase,currentFont + ['Lower'])
